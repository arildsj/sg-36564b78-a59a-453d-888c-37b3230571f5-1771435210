-- Add description column to group_admin_view
...
GROUP BY g.id, g.tenant_id, g.name, g.kind, g.description, g.parent_id, p.name, g.gateway_id, gw.name, g.created_at, g.updated_at;
