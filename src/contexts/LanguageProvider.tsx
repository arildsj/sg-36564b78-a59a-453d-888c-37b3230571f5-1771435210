...
const translations: Record<string, Record<Language, string>> = {
  ...
  "inbox.type_message": { no: "Skriv melding...", en: "Type message...", de: "Nachricht eingeben...", fr: "Tapez le message...", es: "Escriba el mensaje...", it: "Scrivi messaggio...", pl: "Wpisz wiadomość..." },
  ...
  "contacts.description": { no: "Administrer kontakter og grupper", en: "Manage contacts and groups", de: "Kontakte und Gruppen verwalten", fr: "Gérer les contacts et les groupes", es: "Gestionar contactos y grupos", it: "Gestisci contatti e gruppi", pl: "Zarządzaj kontaktami i grupami" },
  ...
  "contacts.search_filter": { no: "Filter", en: "Filter", de: "Filter", fr: "Filtre", es: "Filtro", it: "Filtro", pl: "Filtr" },
  "contacts.search_placeholder": { no: "Søk kontakter...", en: "Search contacts...", de: "Kontakte suchen...", fr: "Rechercher des contacts...", es: "Buscar contactos...", it: "Cerca contatti...", pl: "Szukaj kontaktów..." },
  "contacts.count": { no: "kontakter", en: "contacts", de: "Kontakte", fr: "contacts", es: "contactos", it: "contatti", pl: "kontakty" },
  "contacts.created": { no: "Opprettet", en: "Created", de: "Erstellt", fr: "Créé", es: "Creado", it: "Creato", pl: "Utworzono" },
  ...
  "sending.type_your_message": { no: "Skriv meldingen din her...", en: "Type your message here...", de: "Geben Sie Ihre Nachricht hier ein...", fr: "Tapez votre message ici...", es: "Escriba su mensaje aquí...", it: "Digita il tuo messaggio qui...", pl: "Napisz swoją wiadomość tutaj..." },
  ...
  "admin.create_group": { no: "Ny gruppe", en: "New group", de: "Neue Gruppe", fr: "Nouveau groupe", es: "Nuevo grupo", it: "Nuovo gruppo", pl: "Nowa grupa" },
  ...
  "admin.select_parent": { no: "Velg overgruppe", en: "Select parent", de: "Zielgruppe auswählen", fr: "Sélectionner le groupe cible", es: "Seleccionar grupo objetivo", it: "Seleziona gruppo padre", pl: "Wybierz grupę nadrzędną" },
  ...
  "admin.select_fallback": { no: "Velg målgruppe", en: "Select fallback", de: "Zielgruppe auswählen", fr: "Sélectionner le groupe cible", es: "Seleccionar grupo objetivo", it: "Seleziona gruppo target", pl: "Wybierz grupę docelową" },
