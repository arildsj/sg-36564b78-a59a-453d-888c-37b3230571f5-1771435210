...
const translations: Record<string, Record<Language, string>> = {
  ...
  "contacts.search_filter": { no: "Søk & Filter", en: "Search & Filter", de: "Suchen & Filtern", fr: "Recherche & Filtre", es: "Buscar y Filtrar", it: "Cerca e Filtra", pl: "Szukaj i Filtruj" },
  "contacts.search_placeholder": { no: "Søk etter navn, telefon...", en: "Search by name, phone...", de: "Suche nach Name, Telefon...", fr: "Rechercher par nom, téléphone...", es: "Buscar por nombre, teléfono...", it: "Cerca per nome, telefono...", pl: "Szukaj według nazwy, telefonu..." },
