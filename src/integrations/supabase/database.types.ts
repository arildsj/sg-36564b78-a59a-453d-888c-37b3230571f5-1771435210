  ...
  public: {
    Tables: {
      ...
      admin_group_permissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_group_permissions_granted_by_fkey"
            columns: ["granted_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "admin_group_permissions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "admin_group_permissions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
