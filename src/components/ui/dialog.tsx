  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // sm+: centered floating dialog (original desktop behaviour).
        ...
        "bottom-0 left-0 top-auto translate-x-0 translate-y-0 rounded-t-xl " +
        "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom " +
        "sm:bottom-auto sm:left-[50%] sm:top-[50%] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg " +
