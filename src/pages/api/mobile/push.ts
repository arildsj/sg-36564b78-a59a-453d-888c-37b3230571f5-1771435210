...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  let resolvedGroupId: string | null = contact.group_id;

  // Find existing open thread for this sender
  ...
  if (existingThread) {
    ...
    // Re-evaluate routing rules — rule changes win over thread history
    ...
    // New thread — evaluate routing rules
